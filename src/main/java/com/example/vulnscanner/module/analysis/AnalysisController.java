...
import com.example.vulnscanner.module.sbom.SbomService;
...
public class AnalysisController {
    ...
    private final com.example.vulnscanner.module.analysis.FileService fileService;

    private final com.example.vulnscanner.module.settings.SettingsService settingsService;
    private final com.example.vulnscanner.module.analysis.StatsService statsService;
    private final com.example.vulnscanner.module.user.UserService userService;
    private final com.example.vulnscanner.module.sbom.SbomService sbomService;

    public AnalysisController(AnalysisService analysisService,
            com.example.vulnscanner.module.analysis.FileService fileService,
            com.example.vulnscanner.module.settings.SettingsService settingsService,
            com.example.vulnscanner.module.analysis.StatsService statsService,
            com.example.vulnscanner.module.user.UserService userService,
            com.example.vulnscanner.module.sbom.SbomService sbomService) {
    ...
    public String results(Model model) {
        ...
        List<com.example.vulnscanner.module.sbom.SbomResult> sbomResults = sbomService.getAllSbomResults();

        List<com.example.vulnscanner.module.analysis.UnifiedResultDto> unifiedResults = new java.util.ArrayList<>();

        // Convert SAST results
        for (AnalysisResult r : sastResults) {
            String requester = r.getRequester() != null ? r.getRequester() : "-";
            unifiedResults.add(new com.example.vulnscanner.module.analysis.UnifiedResultDto(
        ...
        for (com.example.vulnscanner.module.sbom.SbomResult r : sbomResults) {
            String requester = r.getRequester() != null ? r.getRequester() : "-";
            unifiedResults.add(new com.example.vulnscanner.module.analysis.UnifiedResultDto(
    ...
    public org.springframework.http.ResponseEntity<?> runAnalysis(@ModelAttribute AnalysisOption analysisOption,
        ...
        try {
            if (file != null && !file.isEmpty()) {
                ...
                String maxSizeStr = settingsService
                        .getSetting(com.example.vulnscanner.module.settings.SettingsService.KEY_MAX_UPLOAD_SIZE);
                ...
                String resultPath = settingsService
                        .getSetting(com.example.vulnscanner.module.settings.SettingsService.KEY_RESULT_PATH);
        ...
        try {
            com.example.vulnscanner.module.user.User user = ((com.example.vulnscanner.module.user.UserService) userService)
        ...
        if (result.getScanSummary() == null) {
            com.example.vulnscanner.module.analysis.ScanSummary summary = new com.example.vulnscanner.module.analysis.ScanSummary();
    ...
    public List<Map<String, Object>> getAnalysisStatuses() {
        ...
        sbomService.getAllSbomResults().forEach(r -> {
            ...
            if ("RUNNING".equals(r.getStatus())) {
                ...
                com.example.vulnscanner.module.sbom.SbomResult updated = sbomService.getSbomResult(r.getId());
                if (updated != null) {
