...
public class SbomController {
    ...
    public ResponseEntity<?> requestSbomAnalysis(
        ...
        try {
            ...
            try {
                com.example.vulnscanner.module.user.User user = userService.loadUserEntityByUsername(username);
    ...
    private Map<String, Object> convertResultToMap(SbomResult result) {
        List<com.example.vulnscanner.module.sbom.SbomComponent> components = result.getComponents();
        List<Map<String, Object>> componentsList = new java.util.ArrayList<>();
        ...
        for (com.example.vulnscanner.module.sbom.SbomComponent comp : components) {
            ...
            if (comp.getVulnerabilities() != null) {
                for (com.example.vulnscanner.module.sbom.SbomVulnerability vuln : comp.getVulnerabilities()) {
            ...
            if (comp.getLicenses() != null) {
                for (com.example.vulnscanner.module.sbom.SbomLicense lic : comp.getLicenses()) {
                    // Map for component structure
        ...
        if (!allLicenses.isEmpty()) {
            ...
            for (com.example.vulnscanner.module.sbom.SbomComponent c : components) {
