package com.example.vulnscanner.config;
...
@EnableJpaRepositories(basePackages = "com.example.vulnscanner.mocha.repository", entityManagerFactoryRef = "mochaEntityManagerFactory", transactionManagerRef = "mochaTransactionManager")
public class MochaDbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean mochaEntityManagerFactory(
        ...
        return builder
                ...
                .packages("com.example.vulnscanner.mocha.entity")
